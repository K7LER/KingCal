...
uses
  ...
  Forms, Dialogs, StdCtrls, TheKing, KingTool, Grids;
...
procedure TFrmMain.KingCalendar1DragOver(Sender, Source: TObject; X,
  Y: Integer; State: TDragState; var Accept: Boolean);
begin
     Accept := True;
end;

procedure TFrmMain.KingCalendar1DragDrop(Sender, Source: TObject; X,
  Y: Integer);
var
 Text: String;
begin
...
begin
     ...
     MessageDlg( 'You have a type ' + IntToStr( KingCalendar1.GetApptLevel ) + ' Appointment Today!',
